...
const {Color, PartSegmentation, PersonSegmentation} = require('@tensorflow-models/body-pix/dist/types');
const {SemanticPartSegmentation, SemanticPersonSegmentation} = require('@tensorflow-models/body-pix/dist/types');
const {getInputSize} = require('@tensorflow-models/body-pix/dist/util');
...
function assertSameDimensions(
    ...
    {width: widthB, height: heightB}, nameA,
    nameB) {
...
function createBodyPartMask(
    ...
    bodyPartIdsToMask, edgeBlurAmount) {
  const backgroundMaskImage = toMask(
